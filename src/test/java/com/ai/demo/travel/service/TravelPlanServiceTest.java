...
class TravelPlanServiceTest {
    ...
    void testSave_shouldStoreTravelPlan() {
        ...
        TravelPlanDTO dto = TravelPlanDTO.builder()
                .destinationCountries(List.of("PT"))
                .destinationCities(List.of("Lisbon"))
        ...
        assertEquals("PT", saved.getDestinationCountries().get(0));
        assertEquals("Lisbon", saved.getDestinationCities().get(0));
    ...
    void testFindAllByUser_shouldReturnPlansForUser() {
        ...
        TravelPlan plan = TravelPlan.builder()
                ...
                .destinationCountries(List.of("ES"))
                .destinationCities(List.of("Madrid"))
        ...
        assertEquals("Madrid", results.get(0).getDestinationCities().get(0));
        assertEquals("ES", results.get(0).getDestinationCountries().get(0));
    }
}
